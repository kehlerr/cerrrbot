...
class MessageActions:
    ...
    NOTE = MessageAction("NOTE", "Note", 2, "add_note")
    TODO = MessageAction("NOTO", "ToDo", 3, "note_todo")
    BOOKMARK = MessageAction("AB", "Add bookmark", 4, "note_bookmark_url")
    DELETE_FROM_CHAT = MessageAction("DFC", "Delete from chat", 1, "delete_from_chat")
    DELETE_NOW = MessageAction("DELN", "Delete now", 1, "delete")
    DELETE_1 = MessageAction("DEL1", "Del in 15m", 2, "_delete_after_time", [DELETE_TIMEOUT_1])
    DELETE_2 = MessageAction("DEL2", "Del in 12H", 3, "_delete_after_time", [DELETE_TIMEOUT_2])
    DELETE_3 = MessageAction("DEL3", "Del in 48H", 4, "_delete_after_time", [DELETE_TIMEOUT_3])

    ALL = [
        NONE, DELETE_REQUEST, SAVE, DOWNLOAD_FILE, DOWNLOAD_ALL, DOWNLOAD_ALL,
        DOWNLOAD_DELAY, NOTE, TODO, BOOKMARK, DELETE_FROM_CHAT, DELETE_NOW, DELETE_1, DELETE_2,
        DELETE_3
    ]
